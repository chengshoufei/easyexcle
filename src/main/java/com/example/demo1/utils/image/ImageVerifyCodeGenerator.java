package com.example.demo1.utils.image;
...
/**
 * @ClassName ImageVerifyCodeGenerator
 * @Date 2022/8/1 16:18
 * @Author chengshoufei
...
public class ImageVerifyCodeGenerator {
    ...
    public static BufferedImage initImage ( int width , int height , int imageType ) {
        ...
        for (int i = 0; i < 6; i++) {
            ...
            graphics.setColor ( c );
            graphics.drawLine ( 0 , r.nextInt ( height ) , width , r.nextInt ( height ) );
        }
        return image;
    }
    ...
    public static void main ( String[] args ) {
        //正则
        String s = "123123131345645" + "asdqwe" + "img";
        String a = "[<>]|(img)|(img)";
